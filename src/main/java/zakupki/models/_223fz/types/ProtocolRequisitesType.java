 ...
 * Реквизиты протокола
 * 
 * <p>Java class for protocolRequisitesType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolRequisitesType">
 *   &lt;complexContent>
...
@XmlType(name = "protocolRequisitesType", propOrder = {
    "guid",
    "registrationNumber",
    "version",
    "publicationDateTime"
...
@XmlSeeAlso({
    ProtocolRequisitesType2 .class
})
public class ProtocolRequisitesType {
