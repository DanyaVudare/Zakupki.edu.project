...
import zakupki.models._223fz.types.PlanInformationType;
...
public class NotificationIssueData {
    ...
    @XmlElement(required = true)
    protected ConclusionComplianceInfo conclusionComplianceInfo;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link ConclusionComplianceInfo }
     *     
     */
    public ConclusionComplianceInfo getConclusionComplianceInfo() {
     ...
     *     
     */
    public void setConclusionComplianceInfo(ConclusionComplianceInfo value) {
