...
import zakupki.models._223fz.types.LotCancellationInfoType;
import zakupki.models._223fz.types.LotCancellationType;
...
public class PurchaseLotCancellationData {
    ...
    @XmlElement(required = true)
    protected CancelledLots cancelledLots;
     ...
     *     
     */
    public CancelledLots getCancelledLots() {
     ...
     *     
     */
    public void setCancelledLots(CancelledLots value) {
    ...
    public static class CancelledLots {
        ...
        @XmlElement(required = true)
        protected List<CancelledLot> cancelledLot;
         ...
         * 
         */
        public List<CancelledLot> getCancelledLot() {
            if (cancelledLot == null) {
                cancelledLot = new ArrayList<CancelledLot>();
            }
