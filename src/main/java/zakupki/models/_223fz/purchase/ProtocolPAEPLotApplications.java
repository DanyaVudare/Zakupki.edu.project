 ...
 * 
 * <p>Java class for protocolPAEPLotApplications complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolPAEPLotApplications">
 *   &lt;complexContent>
 ...
 *           &lt;/element>
 *         &lt;/choice>
 *         &lt;element name="application" type="{http://zakupki.gov.ru/223fz/purchase/1}protocolPAEPApplicationType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "protocolPAEPLotApplications", propOrder = {
    "guid",
    "ordinalNumber",
    "subject",
    "currency",
...
public class ProtocolPAEPLotApplications {
    ...
    protected List<ProtocolPAEPApplicationType> application;
     ...
     * {@link ProtocolPAEPApplicationType }
     * 
     * 
     */
    public List<ProtocolPAEPApplicationType> getApplication() {
        if (application == null) {
            application = new ArrayList<ProtocolPAEPApplicationType>();
        }
