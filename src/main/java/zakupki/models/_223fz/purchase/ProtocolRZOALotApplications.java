...
/**
 * Рассмотрение заявок аукциона по лоту
 * 
 * <p>Java class for protocolRZOALotApplications complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolRZOALotApplications">
 *   &lt;complexContent>
 ...
 *           &lt;/element>
 *         &lt;/choice>
 *         &lt;element name="application" type="{http://zakupki.gov.ru/223fz/purchase/1}protocolRZOAApplicationType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "protocolRZOALotApplications", propOrder = {
    "guid",
    "ordinalNumber",
    "subject",
    "currency",
...
public class ProtocolRZOALotApplications {
    ...
    protected List<ProtocolRZOAApplicationType> application;
     ...
     * {@link ProtocolRZOAApplicationType }
     * 
     * 
     */
    public List<ProtocolRZOAApplicationType> getApplication() {
        if (application == null) {
            application = new ArrayList<ProtocolRZOAApplicationType>();
        }
