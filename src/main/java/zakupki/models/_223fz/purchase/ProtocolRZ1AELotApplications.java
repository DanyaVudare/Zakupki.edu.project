...
/**
 * Рассмотрение первых частей заявок аукциона по лоту
 * 
 * <p>Java class for protocolRZ1AELotApplications complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolRZ1AELotApplications">
 *   &lt;complexContent>
 ...
 *           &lt;/element>
 *         &lt;/choice>
 *         &lt;element name="application" type="{http://zakupki.gov.ru/223fz/purchase/1}protocolRZ1AEApplicationType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "protocolRZ1AELotApplications", propOrder = {
    "guid",
    "ordinalNumber",
    "subject",
    "currency",
...
public class ProtocolRZ1AELotApplications {
    ...
    protected List<ProtocolRZ1AEApplicationType> application;
     ...
     * {@link ProtocolRZ1AEApplicationType }
     * 
     * 
     */
    public List<ProtocolRZ1AEApplicationType> getApplication() {
        if (application == null) {
            application = new ArrayList<ProtocolRZ1AEApplicationType>();
        }
