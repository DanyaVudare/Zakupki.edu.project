package zakupki.database.purchase_contract;
...
import zakupki.database.DeliveryPlaceRepository;
import zakupki.database.NonResidentInfoRepository;
import zakupki.database.SupplierInfoRepository;
